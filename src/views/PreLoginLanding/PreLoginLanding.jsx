...
const PreLoginLanding = () => {
  ...
  return (
    <>
      <div
        className="h-[100vh] bg-cover bg-center flex flex-col text-white"
      ...
      >
          ...
          <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-22">
              <div className="mr-4 mt-2">
                <img src={logoIEEE} alt="Logo" className="w-100 h-20" />
              </div>
        ...
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <div className="space-x-4 mt-8">
            <button 
                className="bg-white text-black text-xl py-2 px-[3rem] rounded-full border border-black"
                onClick={() => navigate('/login')}
            >
              LOG IN
            </button>
            <button 
                className="bg-[#C72F55] text-white text-xl px-[3rem] py-2 rounded-full"
